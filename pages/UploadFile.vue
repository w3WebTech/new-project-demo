    ...
    >
      <div class="md:w-[40%] md:mx-auto px-4 relative h-full pb-20">
        <div class="md:pt-5 sm:pt-10 pb-2 relative max-w-md mx-auto">
              ...
              >
                <div v-if="!aadhaarFile" class="text-center">
                  <svg class="mx-auto h-8 w-8 text-gray-400" stroke="currentColor" fill="none" viewBox="0 0 48 48">
                    <path d="M28 8H12a4 4 0 00-4 4v20m32-12v8m0 0v8a4 4 0 01-4 4H12a4 4 0 01-4-4v-4m32-4l-3.172-3.172a4 4 0 00-5.656 0L28 28M8 32l9.172-9.172a4 4 0 015.656 0L28 28m0 0l4-4m4-4h8m-4-4v8m-12 4h.02" stroke-width="2" stroke-linecap="round" stroke-line join="round" />
                  </svg>
          ...
          <div class="sm:fixed sm:bottom-0 sm:left-0 sm:right-0 sm:p-4 sm:bg-white md:my-10">
            <div class="">
              <button
                type="submit"
...
const isComplete = computed(() => aadhaarFile.value && panFile.value && epFile.value);
...
const processFile = (file: File, type: 'aadhaar' | 'pan' | 'ep') => {
