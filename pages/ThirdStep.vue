...
const nextStep = () => {
  isStepVerify.value = false;
  isOccupation.value = true;
};
const occupationVal = (val: string) => {
  userOccupation.value = val;
  isOccupation.value = false;
